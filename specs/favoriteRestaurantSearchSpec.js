...
import FavoriteRestaurantSearchPresenter from '../src/scripts/view/page/liked-restaurants/favorite-restaurant-search-presenter';
import FavoriteRestaurantSearchView from '../src/scripts/view/page/liked-restaurants/favorite-restaurant-search-view';
...
describe('Searching restaurants', () => {
  ...
  describe('When query is not empty', () => {
    ...
    it('should show the restaurants found by Favorite Restaurants', (done) => {
      document.querySelector('.restaurant-result-container').addEventListener('restaurants:updated', () => {
    ...
    it('should show the name of the restaurants found by Favorite Restaurants', (done) => {
      document.querySelector('.restaurant-result-container').addEventListener('restaurants:updated', () => {
        const restaurantNames = document.querySelectorAll('.title');
    ...
    it('should show - when the restaurant returned does not contain a name ', (done) => {
      document
        .querySelector('.restaurant-result-container').addEventListener('restaurants:updated', () => {
          const restaurantNames = document.querySelectorAll('.title');
